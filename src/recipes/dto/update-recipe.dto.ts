...
//   static composition(composition: any) {
...
class CompositionInnerDTO {
  ...
  @IsOptional()
  @IsNumber()
  @ApiProperty({ example: '100', description: 'Small description', default: 0 })
  small: number;
  ...
  @IsOptional()
  @IsNumber()
  @ApiProperty({ example: '200', description: 'Large description', default: 0 })
  large: number;
...
export class UpdateRecipeDto {
  ...
  @ValidateNested({ each: true })
  @Type(() => CompositionDTO)
  // @IsUniqueComponentIds()
  composition: CompositionDTO[];
  forbiddenComponentId: string;
...
export class DuplicateRecipeDTO {
  @IsNotEmpty()
  @IsMongoId()
  @ApiProperty({
    example: '6657fbfe25dcddd7d9a02101',
    description: '_id of recipe',
  })
  id: string;
}
