...
export type DumpDeliveriesDocument = DumpDeliveries & Document;

@Schema({ timestamps: true })
export class DumpDeliveries {
...
export const DumpDeliveriesSchema =
  SchemaFactory.createForClass(DumpDeliveries);
